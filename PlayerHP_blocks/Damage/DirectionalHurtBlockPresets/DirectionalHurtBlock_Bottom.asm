...
;========================================================================================
if !DamageType == 0
	print "Deals ", dec(!FixedDamageAmount), " damage to the player underneath."
elseif !DamageType == 1
	print "Deals ", dec(!DamageDividend), "/", dec(!DamageDivisor), " of the player's maximum HP underneath."
else
	print "Instantly kills the player underneath."
endif