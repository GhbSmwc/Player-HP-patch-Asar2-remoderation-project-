...
;========================================================================================
if !DamageType == 0
	print "Deals ", dec(!FixedDamageAmount), " damage to the player on right side of block."
elseif !DamageType == 1
	print "Deals ", dec(!DamageDividend), "/", dec(!DamageDivisor), " of the player's maximum HP on right side of block."
else
	print "Instantly kills the player on right side of block."
endif